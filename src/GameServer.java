...
/**
 * This class Handle the main  server
 * This class make the realtion for the servre
 * This class read the Exchange of the client Game and save them into some fields
 * also write changes of its Game state to a buffer
 */
public class GameServer extends Thread {
	...
	public String setLife=null;

	public String map;
	public boolean gotClient = false;
	...
	public void run() {
		try(ServerSocket server = new ServerSocket(6666)){
			...
			try(Socket client = server.accept()){
				...
				while (true) {
					//reading the place of client's tank
					if (reader.ready()) {
